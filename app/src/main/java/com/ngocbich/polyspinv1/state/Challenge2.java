...
public class Challenge2 extends GameState {
  ...
  //  private Enemy_Manager enemy_manager;
    ...
    public Challenge2(GameStateManager gsm, BitmapImage bitmapImage) {
    ...
    public void draw(Canvas canvas) {
        if (ChallengeState.failed==false) {
            ...
            canvas.drawText("" + timer, 50, 50 + paint.descent() - paint.ascent(), paint);
        }
    }
