...
public class Challenge3 extends GameState {
  ...
  //  private Enemy_Manager enemy_manager;
    ...
    public Challenge3(GameStateManager gsm, BitmapImage bitmapImage) {
    ...
    public void init(BitmapImage bitmapImage) {
        ...
        int yPlayer = (Constants.SCREEN_HEIGHT / 6) * 4 + 75;
        ...
        playerPosition = new Rect(xPlayer - 30, yPlayer - 30, xPlayer + 30, yPlayer + 30);
